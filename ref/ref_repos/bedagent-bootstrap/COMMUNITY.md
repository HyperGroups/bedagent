# COMMUNITY.md · bedagent 社区

> v0.91 · 2026-06-24 · 孔放勋

## 📌 当前状态

👤 bedagent 是单人项目。所有代码由 DeepSeek V4 Pro 和 GLM-5.2 配合生成，作者做产品决策和终审。

**[![GitHub stars](https://img.shields.io/github/stars/HyperGroups/bedagent?style=flat)](https://github.com/HyperGroups/bedagent/stargazers)**
**[![GitHub contributors](https://img.shields.io/github/contributors/HyperGroups/bedagent?style=flat)](https://github.com/HyperGroups/bedagent/graphs/contributors)**
...
- GitHub Issues：[HyperGroups/bedagent/issues](https://github.com/HyperGroups/bedagent/issues)
- ✍️ 作者：孔放勋
