# Evidence.md — Does bedagent actually work?

> We don't answer for you. Below is what people who installed bedagent have reported.
...
| How many were caught by bedagent | __ times |

**One-sentence takeaway**: ___

> Even a single data point matters — this is how bedagent moves from "proof of concept" to "actually useful."

---

## Evidence dashboard

> Users with >1 week of continuous use: pending count. If you're using bedagent daily — not just testing — tell us how long.
...
> Reproducible A/B test results. Run `bash bedagent/scripts/benchmark.sh --platform your-platform` to generate.
