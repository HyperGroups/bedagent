...
| ~/.claude/skills/bedagent/ 部署 | ✅ | 9 个文件 |
| ~/.claude/skills/bedagent/scripts/ | 🔴 | **未部署** |
...
| ② 步数闸生效 | ❌ 未测 | ⚠️ 推断 | scripts/ 未部署到 ~/.claude/skills/bedagent/，无 Hook 机制强制步数限制。**推断**：不生效。但未经运行时验证（CLI 未登录） |
...
|:-:|------|:------:|------|:---:|
| 1 | scripts/ 未部署 | 🔴 高 | 编排引擎完全失效。引擎是 bedagent 的核心差异化能力，但在 v0.82 Claude Code 上只剩文档 | ✅ v0.83 已部署 |
