...
| 3 | verify.sh Skills 路径统计瑕疵 | 🟡 中 | Codex | 统计 `skills/*.md` 而非 `skills/bedagent/*.md`，输出误导 |
...
| 7 | Claude Code scripts/ 未部署 | 🔴 高 | Claude Code | install.sh --platform claude 未复制 scripts/ 到 ~/.claude/skills/bedagent/ |
