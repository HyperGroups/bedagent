...
> 由 bedagent 子 Skill 自动维护。每次任务闭环后，主 Agent 反问自己「有什么值得记住的」→ 写入反思区。
>
> 本文件是格式参考——实际文件在 SKILL.md B1 初始化时自动创建到 `{BEDAGENT_DATA}/think.md`。
>
...
### 当前项目：bedagent Harness | 核心任务：编写 Handbook、设计 Skill
